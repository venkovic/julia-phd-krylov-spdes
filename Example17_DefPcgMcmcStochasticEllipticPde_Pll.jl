...
addprocs(10)
#addprocs(([("hector0", :auto)]), tunnel=true)
#addprocs(([("hector1", :auto)]), tunnel=true)
#addprocs(([("hector2", :auto)]), tunnel=true)
#addprocs(([("rejean", :auto)]), tunnel=true)
...
@everywhere begin
  maxit = 2_000
  tentative_nnode = 32_000 # 4_000, 8_000, 16_000, 32_000, 64_000, 128_000 @ 30 subdomains
  ...
  nvec = ndom
  spdim = 3 * ndom
  precond = "lorasc$(ndom)_1"  # ∈ ("bj$(nbj)_0",
                               #    "lorasc$(ndom)_1")
...
# Run test
#
iters = test_solvers_on_several_chains_pll(nchains, nsmp, Λ, Ψ, Π,
